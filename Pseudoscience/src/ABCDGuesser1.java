    ...
    private static double getPositiveDouble(SimpleReader in, SimpleWriter out) {
        ...
        while (!positiveDouble) {
            ...
            if (FormatChecker.canParseDouble(userInput)) {
                ...
                out.println("You must enter a positive number.");
            }
        }
        return constant;
    }
